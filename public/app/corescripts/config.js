angular.module("MainApp").constant(
  "WizioConfig",
  (function() {
    //BACK END SERVER URL
    //
    ...
    return {
      ...
      S3_EQUIRECTPHOTOS_BUCKET:
        env === "prod" ? "wizio-client-tour-photos" : "test-equirect-photos",
      CLOUDFRONT_DISTRO:
        env === "prod"
          ? "https://cdn.wizio.co/"
          : "https://d1mze0h82dkhhe.cloudfront.net/",
      CLOUDFRONT_DISTRO_UPLOAD_URL:
        env === "prod"
          ? "https://d9cm2bybwkl75.cloudfront.net"
          : "https://d3hemhuxs42asx.cloudfront.net",
      ...
      PhotographerApp: {
        Views: {
          CreateUnitModal:
            MODULESPATH +
            "photographerapp/CreateUnit/createunit.modal.view.html",
          UploadFloorPlanDescision:
            MODULESPATH +
            "photographerapp/UploadFloorPlanDecision/uploadfloorplandecision.modal.html",
          UploadFloorPlan:
            MODULESPATH +
            "photographerapp/UploadFloorPlan/uploadfloorplan.view.html"
        }
      },
      TourPasswordApp: {
        Views: {
          TourPasswordConfirmModal:
            MODULESPATH + "tourpasswordapp/tourpasswordconfirm.modal.html"
        }
      },
      //AdminPanel App
      ...
      ApplicationFormViewsURL:
        MODULESPATH + "applicationapp/applicationformapp/viewtemplates/",

      BuyerDashboardViewsURL:
        MODULESPATH + "accountapp/dashboard/viewtemplates/",
      //Footer Views
      ...
      extProfileMainViewsURL:
        MODULESPATH + "accountapp/extendedprofileapp/main/",
      extProfileViewsURL:
        MODULESPATH + "accountapp/extendedprofileapp/viewtemplates/",
      uploadViews: {
        modals: {
          renameMedia:
            MODULESPATH + "photographerapp/upload/rename-media.modal.view.html"
        }
      },
      pages: {
        about: {
        ...
        dashboard: {
          ...
          reassignTours: {
            view:
              MODULESPATH + "dashboard-app/reassign-tours/reassign-tours.html",
      ...
      directives: {
        ...
        vrPlayerInterface: {
          view:
            MODULESPATH + "vr-player-interface-app/vr-player-interface.html",
      ...
      modals: {
        ...
        RequestShowingApp: {
          RequestShowingForm: {
            view:
              MODULESPATH +
              "request-showing-app/modal/request-showing.mdl.html",
        ...
        reassignTours: {
          main: {
            view:
              MODULESPATH +
              "dashboard-app/reassign-tours/modal/reassign-tours-modal.html",
            controller: "ReassignToursModalCtrl"
          },
          areYouSure: {
            view:
              MODULESPATH +
              "dashboard-app/reassign-tours/modal/reassign-tour-confirm-modal.html",
