angular.module("MainApp").constant(
  ...
  (function() {
    ...
    return {
      ...
      S3_EQUIRECTPHOTOS_BUCKET: env === "prod" ? "wizio-client-tour-photos" : "test-equirect-photos",
      CLOUDFRONT_DISTRO: env === "prod" ? "https://cdn.wizio.co/" : "https://d1mze0h82dkhhe.cloudfront.net/",
      CLOUDFRONT_DISTRO_UPLOAD_URL:
        env === "prod" ? "https://d9cm2bybwkl75.cloudfront.net" : "https://d3hemhuxs42asx.cloudfront.net",
      ...
      PhotographerApp: {
        Views: {
          ...
          UploadFloorPlanDescision:
            MODULESPATH + "photographerapp/UploadFloorPlanDecision/uploadfloorplandecision.modal.html",
