angular.module('Directives').directive('transitionVrPlayerDirv', [
    '$state',
    'LoadingSpinnerFct',
            ...
            link: function(scope, elem, attr) {
                ...
                function newImage() {
                    ...
                    loader.load(scope.photoUrl, function(texture) {
                        ...
                        if (sphere) {
                            remove(sphere);
                            sphere = new THREE.Mesh(new THREE.SphereGeometry(100, 60, 40), new THREE.MeshBasicMaterial({map: texture}));
