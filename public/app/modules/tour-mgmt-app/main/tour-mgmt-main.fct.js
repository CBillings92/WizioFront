  ...
  function($q, $resource, $state, $stateParams, $sessionStorage, AWSFct, TokenSvc, WizioConfig, ModalBuilderFct) {
    var API = {
      subscriptionApartment: {
        media: $resource(
          WizioConfig.baseAPIURL + "subscriptionapartment/:SubscriptionPubId/:SubscriptionApartmentPubId",
          {
      ...
      apartment: {
        chooseParams: $resource(
          WizioConfig.baseAPIURL + "apartment/chooseparams/:param1/:param2/:param3/:param4/:param5/:param6",
          {
            param1: "@id",
            param2: "@pubid",
            param3: "@concatAddr",
    ...
    function updateListing(Listing) {
      return new Promise(function(resolve, reject) {
        API.listing.save({ ListingId: Listing.ListingId }, Listing, function(response) {
