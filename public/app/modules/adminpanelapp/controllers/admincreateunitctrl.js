angular.module("AdminPanelApp").controller("AdminCreateUnitCtrl", [
  "$scope",
  "$sessionStorage",
  "$rootScope",
  "$state",
  ...
  function($scope, $sessionStorage, $rootScope, $state, lodash, UnitResource, SmartSearchSvc, FlexGetSetSvc) {
